    ...
    <form action="{{url('admin/category/'.$cate_info->cate_id)}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <select name="cate_pid">
                        ...
                        <option @if($cate_info->cate_pid==$v->cate_id) selected @endif value="{{$v['cate_id']}}">{{$v['cate_name']}}</option>
                        @endforeach
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" value="{{$cate_info['cate_name']}}" name="cate_name">
                </td>
            </tr>
            <tr>
                <th>分类标题：</th>
                <td>
                    <input type="text" value="{{$cate_info->cate_title}}" class="lg" name="cate_title">
                </td>
            </tr>
            ...
            <tr>
                <th>排序：</th>
                <td>
                    <input type="text" name="cate_order" value="{{$cate_info->cate_order}}" maxlength="5" style="width:50px;">
                </td>
            </tr>
            <tr>
                <th></th>
