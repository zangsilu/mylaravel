...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">友链管理</a> &raquo; 添加友链
</div>
<!--面包屑导航 结束-->
    ...
    <form action="{{url('admin/links')}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" value="http://" name="links_url">
                </td>
            </tr>
            <tr>
                <th>排序：</th>
                <td>
                    <input type="text" name="links_order" maxlength="5" value="0" style="width:50px;">
                </td>
            </tr>
            <tr>
                <th></th>
