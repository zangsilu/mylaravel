    ...
    <form action="{{url('admin/config')}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>类型：</th>
                <td>
                    <label onclick="aa(this)"><input type="radio" class="lg" value="radio" name="config_type">radio</label>
                    <label onclick="aa(this)"><input type="radio" class="lg" value="textarea" name="config_type">textarea</label>
                    <label onclick="aa(this)"><input checked type="radio" class="lg" value="input" name="config_type">input</label>
                </td>
            </tr>
            <tr class="config_type_value">
                <th>类型值：</th>
                <td>
                    <p><input type="text" class="lg" value="" name="config_type_value"></p>
            ...
            <tr>
                <th>备注：</th>
                <td>
                    <textarea name="config_intro"></textarea>
                </td>
            </tr>
            <tr>
                <th></th>
